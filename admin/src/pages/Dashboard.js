        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs">مطعم 50 فاكهة للطلبات والعصائر</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <span className="bg-slate-800 text-slate-200 text-sm px-3 py-1 rounded-lg border border-slate-700">
              المدير: {user?.name || 'أدمن'}
            </span>
            <button
              onClick={logout}
              className="bg-rose-600 hover:bg-rose-700 text-white font-bold px-4 py-2 rounded-xl text-sm shadow transition duration-200"
            >
              تسجيل الخروج
            </button>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-100 max-w-lg w-full overflow-hidden text-right">
            ...
            <form onSubmit={handleProductSubmit} className="p-6 space-y-4">
              ...
              <div className="flex items-center gap-2 pt-2">
                ...
                />
                <label htmlFor="prod-available" className="text-slate-700 text-sm font-semibold cursor-pointer">
